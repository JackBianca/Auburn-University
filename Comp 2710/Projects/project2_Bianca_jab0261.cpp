/* 
* File Nameproject2_Bianca_jab0261.cpp
* Author: Jack Bianca
* 2/23/23
* jab0261@auburn.edu
* I used project2_hints for a guideline
* I used Dr.Li's help in class
* I used google to figure out test cases
* Compile: g++ project2_Bianca_jab0261.cpp -o Project2.out
* ./Project2.out
*/
